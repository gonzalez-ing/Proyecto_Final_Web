...
namespace Proyecto_Final_Web {
    ...
    public partial class ClientesDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ClientesRow AddClientesRow(string Nombre, string Cedula, string Direccion, string Telefono, System.DateTime Fecha) {
...
namespace Proyecto_Final_Web.ClientesDataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clientes] ([Nombre], [Cedula], [Direccion], [Telefono], [Fecha" +
                "]) VALUES (@Nombre, @Cedula, @Direccion, @Telefono, @Fecha)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Clientes] SET [Nombre] = @Nombre, [Cedula] = @Cedula, [Direccion] =" +
                " @Direccion, [Telefono] = @Telefono, [Fecha] = @Fecha WHERE (([ClienteId] = @Ori" +
                "ginal_ClienteId))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ClienteId, Nombre, Cedula, Direccion, Telefono, Fecha FROM dbo.Clientes";
        ...
        public virtual int Insert(string Nombre, string Cedula, string Direccion, string Telefono, System.DateTime Fecha) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Cedula, string Direccion, string Telefono, System.DateTime Fecha, int Original_ClienteId) {
            if ((Nombre == null)) {
