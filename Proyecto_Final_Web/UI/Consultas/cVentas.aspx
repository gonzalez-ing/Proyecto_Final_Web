<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cVentas.aspx.cs" Inherits="Proyecto_Final_Web.UI.Consultas.cVentas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div <h2 class="card-header text-uppercase text-center text-primary"> Consulta De Ventas </h2> </div>
    <div class="form-row">
        ...
        <div class="form-group ">
            ...
            <asp:DropDownList ID="BuscarPorDropDownList" runat="server" CssClass="form-control input-group">
                ...
                <asp:ListItem>Factura Id</asp:ListItem>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="div1">
                        ...
                        <rsweb:reportviewer ID="VentasReporteView" runat="server" ProcessingMode="Remote" Height="718px" Width="1000px">
