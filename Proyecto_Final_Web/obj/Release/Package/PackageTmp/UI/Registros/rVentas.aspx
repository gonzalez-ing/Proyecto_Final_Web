                 ...
                 <span class="fas fa-search"></span> Buscar
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-1">
                            ...
                            <asp:TextBox ID="CantidadTextBox" class="form-control input-sm" OnTextChanged="CantidadTextBox_TextChanged" AutoPostBack="true" AutoCompleteType="Disabled" TextMode="Number" runat="server" placeholder="0"></asp:TextBox>
                        </div>
                    ...
                    <div class="form-row">
                        <asp:GridView ID="DetalleGridView" CssClass=" col-md-offset-4 col-sm-offset-4" runat="server" CellPadding="4" ForeColor="Black" GridLines="None" Width="244px" AutoGenerateColumns="False" 
                            BackColor="#FF9966"  OnSelectedIndexChanged="DetalleGridView_SelectedIndexChanged">
                            <AlternatingRowStyle BackColor="white" />
                            <Columns>
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:Button class="btn btn-danger" ID="removerButton" runat="server" CausesValidation="False" CommandName="Remover" Text="Remover" ></asp:Button>
                                    </ItemTemplate>
                                </asp:TemplateField>
