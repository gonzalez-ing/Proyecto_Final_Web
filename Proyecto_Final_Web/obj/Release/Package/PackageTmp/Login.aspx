<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Proyecto_Final_Web.Registros.Login" %>
        ...
        <aside class="col-sm-4">
            ...
            <div class="card">
                <article class="card-body">
                    <a href="/UI/Registros/rUsuarios.aspx" class="float-right btn btn-outline-primary">Registrarse</a>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                          ...
                          <div id="formFooter">
                    <a class="underlineHover" href="/Default.aspx">Go to the Site</a>
                           </div>
                        <!-- form-group// -->
                    </form>
                </article>
